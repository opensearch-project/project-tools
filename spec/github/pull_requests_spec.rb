  ...
  context 'contributors' do
    context 'org' do
      context 'january 2022' do
        context 'merged', vcr: { cassette_name: 'search/RedHatOfficial/issues_2022-01-01_2022-01-31' } do
          subject do
            GitHub::PullRequests.new(org: 'RedHatOfficial', from: Date.new(2022, 1, 1), to: Date.new(2022, 1, 31), page: 7, status: :merged)
          end
        ...
        context 'unmerged', vcr: { cassette_name: 'search/RedHatOfficial/issues_unmerged_2022-01-01_2022-01-31' } do
          subject do
            GitHub::PullRequests.new(org: 'RedHatOfficial', from: Date.new(2022, 1, 1), to: Date.new(2022, 1, 31), page: 7, status: :unmerged)
          end
    ...
    context 'org + repo' do
      context 'january 2022', vcr: { cassette_name: 'search/multiple/issues_org_and_repo_2022-01-01_2022-01-31' } do
        subject do
          GitHub::PullRequests.new(org: 'RedHatOfficial', repo: 'aws/aws-cli', from: Date.new(2022, 1, 1), to: Date.new(2022, 1, 31), page: 7, status: :merged)
        end
    ...
    context 'repo' do
      context 'RedHatOfficial.github.io', vcr: { cassette_name: 'search/RedHatOfficial/RedHatOfficial.github.io/issues_2022-09-01_2022-09-31' } do
        subject do
          GitHub::PullRequests.new(org: 'RedHatOfficial', repo: 'RedHatOfficial.github.io', from: Date.new(2022, 9, 1), to: Date.new(2022, 9, 30), page: 31, status: :merged)
        end
    ...
    context 'repos' do
      context 'mulitple', vcr: { cassette_name: 'search/RedHatOfficial/multiple/issues_2022-01-01_2022-01-30' } do
        subject do
          GitHub::PullRequests.new(org: 'RedHatOfficial', repo: ['GoCourse', 'RedHatOfficial.github.io'], from: from, to: to, page: page, status: :merged)
        end

        let(:from) { Date.new(2022, 1, 1) }
        let(:to) { from + 30 }
        let(:page) { 31 }
        let(:first) { GitHub::PullRequests.new(org: 'RedHatOfficial', repo: ['GoCourse'], from: from, to: to, page: page, status: :merged) }
        let(:second) { GitHub::PullRequests.new(org: 'RedHatOfficial', repo: ['RedHatOfficial.github.io'], from: from, to: to, page: page, status: :merged) }
